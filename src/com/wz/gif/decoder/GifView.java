...
//        }
    ...
    private DecodeFinish decodeFinish;
    
    public void setFinishListener(DecodeFinish decodeFinish){
    ...
    protected Parcelable onSaveInstanceState() {
        Log.d("onSaveInstanceState free gifDecoder");
...
//    }
    ...
    /**
     * 当解析完成的时候会调用ok方法，这里执行绘制的线程，
     * @hide
     */
    public void parseOk(boolean parseStatus,int frameIndex){
        if(parseStatus){
            if(gifDecoder != null){
                Log.d(animationType+" is type");
                ...
                case ONE_FRAME:
                    //TODO：没有加显示一帧的图片。
//                    getOneFrame(gifDecoder.getImage());
                    if(gifDecoder.getImage() != null){
                        setFirstBitmap(gifDecoder.getImage());
                        decodeFinish.decodeFinish();
                        reDraw();
//                        setImageBitmap(gifDecoder.getImage());
                    }
                    break;
                }
     ...
     * @return
     */
    private Bitmap getOneFrame(Bitmap image) {
        return image;
    }
    ...
    private void drawImage(){
        if(animationType == GifImageType.ONE_FRAME){
            setImageBitmap(gifDecoder.getImage());
            return ;
        }else{
...
//            Log.d("handle message:准备画图");
    ...
    private class DrawThread extends Thread{    
        public void run(){
            ...
            while(isRun){
//                Log.d("总共:"+gifDecoder.getFrameCount());
                //TODO:修改,主要是对isRun的改变
                if(oneFrame == true){
                    reDraw();
                    isRun = false;
                }
     ...
     * @param b
     */
    public void setOneFrame(boolean b) {
        oneFrame = b;
    }
